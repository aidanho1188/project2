...
public class Deck {
	...
	public void shuffle() {
		...
		Card[] array = new Card[MAX_SIZE]; // remove car from the list and place at random posistions in an array
		while (cards.size() > 0) {
		...
		for (Card card : array) // Transfer and shuffled cards back to the list
			cards.add(card);
	}
